 ...
 */
class Image extends \API\V1\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'API\\V1\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'API\\V1\\Entity\\Image' . "\0" . 'mime'];
        }
