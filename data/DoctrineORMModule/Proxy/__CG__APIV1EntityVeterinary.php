 ...
 */
class Veterinary extends \API\V1\Entity\Veterinary implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'API\\V1\\Entity\\Veterinary' . "\0" . 'id', '' . "\0" . 'API\\V1\\Entity\\Veterinary' . "\0" . 'document', '' . "\0" . 'API\\V1\\Entity\\Veterinary' . "\0" . 'histories', '' . "\0" . 'API\\V1\\Entity\\Veterinary' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Veterinary $proxy) {
